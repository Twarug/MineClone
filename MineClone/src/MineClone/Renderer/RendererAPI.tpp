...
namespace mc
{
    ...
    Ref<AllocatedBuffer> RendererAPI::CreateVertexBuffer(std::span<Vertex> data) {
        ...
        auto vertexBuffer = CreateBuffer(size, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT,
    ...
    Ref<AllocatedBuffer> RendererAPI::CreateIndexBuffer(std::span<Index> data) {
        ...
        auto vertexBuffer = CreateBuffer(size, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT,
                                         VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
